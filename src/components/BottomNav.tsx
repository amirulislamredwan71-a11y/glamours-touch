...
const BottomNav = () => {
  ...
  return (
    <nav className="fixed bottom-1.5 left-3.5 right-3.5 z-50 sm:hidden bg-[#0a0d11]/94 backdrop-blur-2xl border border-gtgold/40 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.92)] px-2 py-1">
