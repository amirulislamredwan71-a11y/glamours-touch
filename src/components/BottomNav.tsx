...
const BottomNav = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 sm:hidden bg-[#0a0d11]/96 backdrop-blur-2xl border-t border-gtgold/40 rounded-t-2xl shadow-[0_-8px_30px_rgba(0,0,0,0.95)] px-2 pt-1.5 pb-2">
