...
const BottomNav = () => {
  ...
  return (
    <nav className="fixed bottom-3 left-3 right-3 z-50 sm:hidden bg-[#0a0d11]/92 backdrop-blur-2xl border border-gtgold/40 rounded-2xl shadow-[0_12px_36px_rgba(0,0,0,0.92)] px-2 py-1">
