    ...
    <>
      ...
      {!open && (
        <motion.div
          ...
          className="fixed left-2 right-2 sm:left-auto sm:right-6 sm:w-[370px] bottom-[72px] sm:bottom-6 z-[90] flex items-center justify-between gap-2 rounded-full pl-2.5 pr-1.5 py-1.5 border border-gtgold/40 backdrop-blur-md"
