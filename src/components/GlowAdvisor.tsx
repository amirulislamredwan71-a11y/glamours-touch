    ...
    <>
      ...
      {!open && (
        <motion.button
          ...
          className="fixed left-4 bottom-[74px] sm:bottom-6 z-[90] bg-[#161d22] border-2 border-gtgold text-white hover:bg-gtgold hover:text-black font-black text-xs px-4 py-2.5 rounded-full flex items-center gap-2 shadow-2xl hover:scale-105 transition-all group backdrop-blur-md"
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-[84px] sm:bottom-6 left-2 right-2 sm:right-auto sm:left-6 sm:w-[380px] z-[100] rounded-3xl shadow-2xl border border-gtgold/25 flex flex-col overflow-hidden gt-card"
