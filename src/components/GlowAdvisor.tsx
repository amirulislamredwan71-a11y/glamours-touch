    ...
    <>
      ...
      {!open && (
        <motion.div
          ...
          className="fixed left-2 right-2 sm:left-auto sm:right-6 sm:w-[370px] bottom-[68px] sm:bottom-6 z-[90] flex items-center justify-between gap-2 rounded-full pl-2.5 pr-1.5 py-1.5 border border-gtgold/40 backdrop-blur-md"
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-[68px] sm:bottom-6 left-2 right-2 sm:left-auto sm:right-6 sm:w-[380px] z-[100] rounded-3xl shadow-2xl border border-gtgold/25 flex flex-col overflow-hidden gt-card"
